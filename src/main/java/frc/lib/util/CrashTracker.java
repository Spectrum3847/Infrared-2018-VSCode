    ...
    private static void logMarker(String mark, Throwable nullableException) {
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter("/home/lvuser/crash_tracking.txt", true))) {
            ...
            if (DriverStation.getInstance().isFMSAttached()) {
                writer.print(", " + DriverStation.getInstance().getEventName());
                writer.print(", match:" + DriverStation.getInstance().getMatchNumber());
                writer.print(", replay:" + DriverStation.getInstance().getReplayNumber());
                writer.print(", matchTime:" + DriverStation.getInstance().getMatchTime());
                writer.print(", station:" + DriverStation.getInstance().getLocation());
            }
