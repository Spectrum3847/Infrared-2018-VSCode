...
import frc.paths.FiveFeet;
import frc.paths.FiveFeetAndTurn;
import frc.paths.LeftCrossScale;
import frc.paths.LeftSideRightScale;
import frc.paths.LeftSwitchCenter;
import frc.paths.LeftSwitchCenter2;
import frc.paths.TestSTurnAuto;
import frc.paths.ThreeFeet;
import frc.robot.commands.FollowTrajectory;
import frc.robot.commands.AutoTune.AutoTuneVelocity;
import frc.robot.commands.auto.DriveForTime;
import frc.robot.commands.auto.InPlaceTurn;
import frc.robot.commands.auto.WaitBeforeAuton;
import frc.robot.commands.auto.modes.CenterSWnoSensor;
import frc.robot.commands.auto.modes.CenterSWpigeon;
import frc.robot.commands.auto.modes.LeftSW;
import frc.robot.commands.auto.modes.LeftSWOneAndHalf;
import frc.robot.commands.auto.modes.LeftSWOneAndHalfPlusArc;
import frc.robot.commands.auto.modes.LeftSWTwoAndHalf;
import frc.robot.commands.auto.modes.LeftScale2Cube;
import frc.robot.commands.auto.modes.LeftScaleMode;
import frc.robot.commands.auto.modes.LeftSneakyScaleMode;
import frc.robot.commands.auto.modes.RightSW;
import frc.robot.commands.auto.modes.RightSWOneAndHalf;
import frc.robot.commands.auto.modes.RightSWOneAndHalfPlusArc;
import frc.robot.commands.auto.modes.RightSWTwoAndHalf;
import frc.robot.commands.auto.modes.RightScaleMode;
import frc.robot.commands.auto.modes.RightSneakyScaleMode;
import frc.robot.commands.auto.modes.StraightSW;
import frc.robot.commands.drivetrain.TestVelocityMode;
