...
public class AutoTuneVelocityCalculateP extends Command {
    ...
    public AutoTuneVelocityCalculateP(Subsystem requiredSubsystem, SpectrumTalonSRX talon, int srxParameterSlot, double desiredVelocity, int numSamplesRequired) {
    	this._talon = talon;
