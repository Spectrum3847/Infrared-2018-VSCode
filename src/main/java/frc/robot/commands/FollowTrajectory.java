...
import frc.lib.util.SrxTrajectoryImporter;
...
public class FollowTrajectory extends Command {
	...
	private SpectrumTalonSRX rightTalon = Robot.drive.rightSRX;
	private SpectrumTalonSRX leftTalon = Robot.drive.leftSRX;
	...
	private class BufferLoader implements java.lang.Runnable {
		...
		public void run() {
			...
			leftLastPointSent = manageBuffer(leftTalon, trajectoryToFollow.leftProfile, Robot.drive.LOW_GEAR_PROFILE, leftLastPointSent);
			rightLastPointSent = manageBuffer(rightTalon, trajectoryToFollow.rightProfile, Robot.drive.LOW_GEAR_PROFILE, rightLastPointSent);
		}
		
		private int manageBuffer(SpectrumTalonSRX talon, SrxMotionProfile prof, int pidfSlot, int lastPointSent) {
